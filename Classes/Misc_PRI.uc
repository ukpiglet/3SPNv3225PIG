...
var int SGCount;				// number of sg kills

var int PlayedRounds;           // the number of rounds that the player has played
var float EndOfRoundScore;      // the score they had at the end of the last round
...
var int         SGDamage;
var int         HeadShots;
var int			LongestHeadShotDistance;
...
defaultproperties
{
     ...
     PawnInfoClass=Class'3SPNv3225PIG.Misc_PawnReplicationInfo'
}
