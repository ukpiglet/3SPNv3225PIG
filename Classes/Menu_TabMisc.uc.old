...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
	...
	//footsteps
	moCheckBox(Controls[5]).Checked(class'Misc_Pawn'.default.bPlayOwnLandings);
	...
	NetUpdateRate(class'Misc_Player'.default.ClientReplRateBehavior, False);
...
function OnChange(GUIComponent C)
{
    ...
    if(moCheckBox(c) != None)
    {
        ...
        if(c == Controls[1])
            ...
            class'Misc_Pawn'.default.bPlayOwnLandings = b;
    ...
    else if(GUISlider(c) != None)
    {
        switch(c)
        {
			...
			case Controls[29]:
				...
				NetUpdateRate(GUISlider(c).Value, True);
				break;
        }
    }
	else{
...
function NetUpdateRate(int MyValue, bool save)
{
	if (save)
		Misc_Player(PlayerOwner()).SetNetUpdateRate(MyValue);

	if (MyValue == 0)
		GUILabel(Controls[6]).Caption = "Minimum Rate";
	else if (MyValue == 1)
		GUILabel(Controls[6]).Caption = "Middle rate (250+ fps)";
	else if (MyValue == 2)
		GUILabel(Controls[6]).Caption = "Max rate equal to your FPS";
}
...
defaultproperties
{
     ...
     Begin Object Class=moCheckBox Name=PlayOwnLandingsCheckBox
         ...
         WinWidth=0.800000
     End Object
     Controls(5)=PlayOwnLandingsCheckBox
     ...
     Begin Object Class=GUILabel Name=SliderCaption
         Caption="Hitsound Volume:"
         TextColor=(B=255,G=255,R=255)
         WinTop=0.07000
         WinLeft=0.700000
         WinWidth=0.200000
     End Object
     Controls(6)=SliderCaption

     Begin Object Class=GUILabel Name=SliderLabel
...
//Stubs
	...
	Begin Object Class=GUILabel Name=Dummy
         Caption=""
     End Object
	 //Controls(5)=Dummy
	 //Controls(6)=Dummy
