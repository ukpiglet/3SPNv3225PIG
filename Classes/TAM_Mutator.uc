...
var bool bShow3SPNMessage;
var color SPNMessageColour;
...
local string Menu3SPNKey;
	...
	if (bShow3SPNMessage && PlayerController(Other.Controller)!=None)
  	{
		Menu3SPNKey = class'Interactions'.static.GetFriendlyName(class'Misc_Player'.default.Menu3SPNKey);
		PlayerController(Other.Controller).ClientMessage(Level.Game.MakeColorCode(SPNMessageColour)$"Access the 3SPN configuration menu by pressing"@Menu3SPNKey@"or typing 'menu3spn' in the console.");
	}
...
function InitWeapons(int AssaultAmmo,int AssaultGrenades,int BioAmmo,int ShockAmmo,int LinkAmmo,int MiniAmmo,int FlakAmmo,int RocketAmmo,int LightningAmmo)
{
    ...
    class'Freon_BioGlob'.default.MyDamageType = class'DamType_BioGlob';
...
function ResetWeaponsToDefaults(bool bModifyShieldGun)
{
    ...
    class'Freon_BioGlob'.default.MyDamageType = class'DamTypeBioGlob';
	...
	class'ShieldFire'.default.DamageType=class'DamType_ShieldImpact';  //not sure if this is needed....but it shouldn't hurt
	...
	if(EnableNewNet)
	{
		...
		class'DamType_ShieldImpact'.default.WeaponClass = class'xWeapons.ShieldGun';
		...
		class'DamTypeLinkShaft'.default.WeaponClass = class'xWeapons.LinkGun';
...
defaultproperties
{
     ...
     NewNetWeaponClasses(0)=Class'3SPNv3225PIG.NewNet_ShockRifle'
     NewNetWeaponClasses(1)=Class'3SPNv3225PIG.NewNet_LinkGun'
     NewNetWeaponClasses(2)=Class'3SPNv3225PIG.NewNet_MiniGun'
     NewNetWeaponClasses(3)=Class'3SPNv3225PIG.NewNet_FlakCannon'
     NewNetWeaponClasses(4)=Class'3SPNv3225PIG.NewNet_RocketLauncher'
     NewNetWeaponClasses(5)=Class'3SPNv3225PIG.NewNet_SniperRifle'
     NewNetWeaponClasses(6)=Class'3SPNv3225PIG.NewNet_BioRifle'
     NewNetWeaponClasses(7)=Class'3SPNv3225PIG.NewNet_AssaultRifle'
     NewNetWeaponClasses(8)=Class'3SPNv3225PIG.NewNet_ShieldGun'
     NewNetWeaponNames(0)="3SPNv3225PIG.NewNet_ShockRifle"
     NewNetWeaponNames(1)="3SPNv3225PIG.NewNet_LinkGun"
     NewNetWeaponNames(2)="3SPNv3225PIG.NewNet_MiniGun"
     NewNetWeaponNames(3)="3SPNv3225PIG.NewNet_FlakCannon"
     NewNetWeaponNames(4)="3SPNv3225PIG.NewNet_RocketLauncher"
     NewNetWeaponNames(5)="3SPNv3225PIG.NewNet_SniperRifle"
     NewNetWeaponNames(6)="3SPNv3225PIG.NewNet_BioRifle"
     NewNetWeaponNames(7)="3SPNv3225PIG.NewNet_AssaultRifle"
     NewNetWeaponNames(8)="3SPNv3225PIG.NewNet_ShieldGun"
     bShow3SPNMessage=True
     SPNMessageColour=(B=255,G=48,R=155,A=255)
