...
defaultproperties
{
     ...
     InfoText(1)="======="
     InfoText(2)="þ"
     InfoText(3)="Welcome to 3SPN [3SPNVersion], please take a moment to set your preferred settings!"
     InfoText(4)="þ"
     InfoText(5)="Click the button at the bottom of this screen for information on this version of freon, as well as for hints and tips."
     InfoText(6)="þ"
     InfoText(7)="You can access this configuration menu at any time by pressing [Menu3SPNKey] or typing 'menu3spn' in the console."
     InfoText(8)="þ"
     ...
     InfoText(81)=" "
     InfoText(82)="Again, do click the button below for more information on this version of freon, hints and tips."
}
