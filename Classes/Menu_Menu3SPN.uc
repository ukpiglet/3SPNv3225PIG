...
function InitComponent(GUIController MyController, GUIComponent MyOwner)
{
	...
	if(bAdmin)
	{
		TournamentAdminTab = Menu_TabTournamentAdmin(TabC.AddTab("Tournament Admin", "3SPNv3225PIG.Menu_TabTournamentAdmin",, "Tournament", false));
 
		if(PlayerOwner().Level.GRI!=None)
		{
			if(PlayerOwner().Level.GRI.bTeamGame)
				AdminTab = Menu_TabTAMAdmin(TabC.AddTab("Admin", "3SPNv3225PIG.Menu_TabTAMAdmin",, "Admin/Server configuration", false));
			else
				AdminTab = Menu_TabAMAdmin(TabC.AddTab("Admin", "3SPNv3225PIG.Menu_TabAMAdmin",, "Admin/Server configuration", false));
		}
...
defaultproperties
{
     ...
     End Object
     Controls(0)=GUIImage'3SPNv3225PIG.Menu_Menu3SPN.MenuBack'
     ...
     Begin Object Class=GUITitleBar Name=MenuTitle
         ...
         bScaleToParent=True
     End Object
     Controls(1)=GUITitleBar'3SPNv3225PIG.Menu_Menu3SPN.MenuTitle'
