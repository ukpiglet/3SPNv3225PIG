...
function GetServerInfo(out ServerResponseLine ServerState)
{
	...
	//log("AM Advertising as "$ServerState.GameType);
}
...
static function FillPlayInfo(PlayInfo PI)
{
    ...
    PI.AddSetting("3SPN", "CampThreshold", "Camp Area", 0, 30, "Text", "3;0:999");
    PI.AddSetting("3SPN", "bKickExcessiveCampers", "Kick Excessive Campers", 0, 31, "Check");
	PI.AddSetting("3SPN", "bUseCamperIcon", "Camper Icons", 0, 152, "Check");
    ...
    PI.AddSetting("3SPN", "AssaultAmmo", "Assault Ammunition", 0, 61, "Text", "3;0:999");
    PI.AddSetting("3SPN", "AssaultGrenades", "Assault Grenades", 0, 62, "Text", "3;0:999");
    PI.AddSetting("3SPN", "BioAmmo", "Bio Ammunition", 0, 63, "Text", "3;0:999");
    PI.AddSetting("3SPN", "ShockAmmo", "Shock Ammunition", 0, 64, "Text", "3;0:999");
    PI.AddSetting("3SPN", "LinkAmmo", "Link Ammunition", 0, 65, "Text", "3;0:999");
    PI.AddSetting("3SPN", "MiniAmmo", "Mini Ammunition", 0, 66, "Text", "3;0:999");
    PI.AddSetting("3SPN", "FlakAmmo", "Flak Ammunition", 0, 67, "Text", "3;0:999");
    PI.AddSetting("3SPN", "RocketAmmo", "Rocket Ammunition", 0, 68, "Text", "3;0:999");
    PI.AddSetting("3SPN", "LightningAmmo", "Lightning Ammunition", 0, 69, "Text", "3;0:999");

    PI.AddSetting("3SPN", "EnableNewNet", "Enable New Net", 0, 80, "Check");
    PI.AddSetting("3SPN", "bShow3SPNMessage", "Show Menu3SPN message", 0, 81, "Check");
...
{ 
    switch(PropName)
    {
		...
		case "bShow3SPNMessage":	return "Show 3SPN Message.";	
...
function string SwapDefaultCombo(string ComboName)
{
    if(ComboName ~= "xGame.ComboSpeed")
        return "3SPNv3225PIG.Misc_ComboSpeed";
...
function EndRound(PlayerReplicationInfo Scorer)
{
    ...
    if(Scorer == None)
    {
		NextRoundTime = 7;  //make this configurable at some point
        return;
    }
...
defaultproperties
{
     ...
     ScoreBoardType="3SPNv3225PIG.AM_Scoreboard"
     HUDType="3SPNv3225PIG.AM_HUD"
     MapListType="3SPNv3225PIG.MapListArenaMaster"
     GoalScore=5
     MaxLives=1
     TimeLimit=0
     ...
     GameReplicationInfoClass=Class'3SPNv3225PIG.TAM_GRI'
