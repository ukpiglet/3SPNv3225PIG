	...
	)
{
	switch(SwitchNum)
	{
		...
		return static.SomeOneIsCamping(RelatedPRI_1);
	}
}
...
{
    return default.PlayerIsCampingOpen @ Misc_PRI(RelatedPRI).GetColoredNameEx() @ default.PlayerIsCamping @ "(" $ RelatedPRI.GetLocationName() $ ")";
}
